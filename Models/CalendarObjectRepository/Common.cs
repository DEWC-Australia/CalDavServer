...
namespace CalDav.CalendarObjectRepository
{
    ...
    {
        public const string PRODID = CalDavSettings.ProdId;
        ...
        public static readonly XNamespace xCalServer = XNamespace.Get("http://calendarserver.org/ns/");
        ...
        public static DateTime? ToDateTime(this string value)
        {
            ...
            // probably look at a regex
            if(value.Length == 8)
            {
                int year = 0;
                int month = 0;
                int day = 0;
                if(int.TryParse(value.Substring(0, 4), out year) && int.TryParse(value.Substring(4, 2), out month) && int.TryParse(value.Substring(6, 2), out day))
                {
